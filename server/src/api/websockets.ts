...
export const startSocketIO = (server: Server<typeof IncomingMessage, typeof ServerResponse>) => {
  const io = new SocketServer(server, {
    cors: {
      origin: [frontendEnv.URL, webfrontendEnv.URL, "https://api.roomfin.xyz", "https://roommate-finder-production-b646.up.railway.app", "https://www.roomfin.xyz", "http://localhost:3000"],
      pingTimeout: 60000,
    },
  });
