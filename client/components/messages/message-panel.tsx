...
const MessagePanel = ({ typing, receiveTyping, receiveMessage, isDarkMode, showPanel, updateShowPanel, userInfo, chat, socket, updateBlocked, updateMuted }: Props) => {
  ...
  const image = () => {
    if (chat && chat?.userInfo && chat?.userInfo?.image) {
